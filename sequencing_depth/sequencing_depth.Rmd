...
or_table <- data.frame(
  ...
  dplyr::mutate(
    percent_change = (OR - 1) * 100   # negative = reduction, positive = increase
  )
...
if (exists("rare_targets_curve_prep")) {
  export_plot_png(rare_targets_curve_prep, fig_dir, "rare_targets_curve_prep.png", width = 9, height = 5)
}
if (exists("rare_targets_curve_prep_2")) {
  export_plot_png(rare_targets_curve_prep_2, fig_dir, "rare_targets_curve_prep_2.png", width = 9, height = 5)
}
if (exists("rare_targets_curve_prep_3")) {
  export_plot_png(rare_targets_curve_prep_3, fig_dir, "rare_targets_curve_prep_3.png", width = 9, height = 5)
}
if (exists("rare_targets_curve_prep_4")) {
  export_plot_png(rare_targets_curve_prep_4, fig_dir, "rare_targets_curve_prep_4.png", width = 9, height = 5)
}
