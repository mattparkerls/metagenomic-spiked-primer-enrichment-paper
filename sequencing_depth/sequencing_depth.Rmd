...
fixed_tbl_div_kbl = kable(fixed_tbl_div, digits = 3, caption = "The fixed effects of sequencing depth on microbial diversity")
...
# Optional: use kable() to print nicely in RMarkdown
fixed_tbl_kbl = kable(fixed_tbl, digits = 3, caption = "The fixed effects of sequencing depth on detecting targeted viruses")
